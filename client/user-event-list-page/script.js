...
function getEventHtml(event){
    ...
    <img class="mer1" src="/picture.jpg"  alt="">\
    <div class="Stand"><h2 class="name">'+event[0]+'</h2></div>\
    <button class="zapicaca" onclick="onClickButton('+event[1]+')">ЗАПИСАТЬСЯ</button>\
    </div>';
}

function onClickButton(id){
    window.location.href = "/register-human-in-queue?queueId="+id;
}
