...
"""
QUEUE_I - база данных для текущего состояния очередей (id PRIMARY KEY, number INTEGER, login TEXT NOT NULL, timestamp INTEGER)
"""
...
REGISTER_PAGE_PATH = ROOT_DIR + "\\client\\register-human-in-queue"
